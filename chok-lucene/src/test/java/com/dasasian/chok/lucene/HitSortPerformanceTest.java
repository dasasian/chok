...
public class HitSortPerformanceTest {
    ...
    public void sortCollection(Hits hits) {
        ...
        hits.sortCollection(hitCount);
        final long end = System.currentTimeMillis();
        System.out.println("sortCollection: " + (end - start) + "ms. for " + hitCount);
    }
    ...
    public void sortMerge(Hits hits) {
        ...
        hits.sortMerge();
        final long end = System.currentTimeMillis();
        System.out.println("sortMerge: " + (end - start) + "ms. for " + hitCount);
    }
    ...
    public void sortOther(Hits hits) {
        ...
        hits.sortOther();
        final long end = System.currentTimeMillis();
        System.out.println("sortOther: " + (end - start) + "ms. for " + hitCount);
    }
    ...
    public void sortOtherII(Hits hits) {
        ...
        hits.sortOtherII();
        final long end = System.currentTimeMillis();
        System.out.println("sortOtherII: " + (end - start) + "ms. for " + hitCount);
    }
