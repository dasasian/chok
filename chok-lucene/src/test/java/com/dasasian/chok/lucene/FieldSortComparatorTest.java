...
public class FieldSortComparatorTest extends AbstractTest {
    ...
    public void testTwoIntFieldCompare() {
        SortField[] sortFields = new SortField[]{new SortField("intField1", SortField.INT), new SortField("intField2", SortField.INT)};
    ...
    public void testStringFieldDocIdCompare() {
        SortField[] sortFields = new SortField[]{new SortField("stringField", SortField.STRING), new SortField("docIdField", SortField.DOC)};
    ...
    public void testStringFieldScoreCompare() {
        SortField[] sortFields = new SortField[]{new SortField("stringField", SortField.STRING), new SortField("scoreField", SortField.SCORE)};
