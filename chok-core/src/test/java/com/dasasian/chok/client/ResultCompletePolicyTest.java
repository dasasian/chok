...
public class ResultCompletePolicyTest extends AbstractTest {
    ...
    public void testCompleteShutdown() {
        ...
        ResultCompletePolicy<String> rc = new ResultCompletePolicy<>(60000);
        ...
        rc = new ResultCompletePolicy<>(60000, true);
        assertEquals("Wait up to 60000 ms for complete results, then shut down.", rc.toString());
        assertTrue(rc.waitTime(r) > 50000);
        r.addResult("x", "a");
        assertTrue(rc.waitTime(r) > 50000);
    ...
    public void testCompleteNoShutdown() {
        ClientResult<String> r = new ClientResult<>(null, "a", "b", "c");
        ResultCompletePolicy<String> rc = new ResultCompletePolicy<>(60000, false);
    ...
    public void testCoverageNoShutdown() {
        ClientResult<String> r = new ClientResult<>(null, "a", "b", "c");
        ResultCompletePolicy<String> rc = new ResultCompletePolicy<>(0, 60000, 0.5, false);
    ...
    public void testCoverageShutdown() {
        ClientResult<String> r = new ClientResult<>(null, "a", "b", "c");
        ResultCompletePolicy<String> rc = new ResultCompletePolicy<>(0, 60000, 0.5, true);
    ...
    public void testCompleteTiming() {
        ClientResult<String> r = new ClientResult<>(null, "a", "b", "c");
        ResultCompletePolicy<String> rc = new ResultCompletePolicy<>(1000, true);
    ...
    public void testCoverageTiming1() {
        ClientResult<String> r = new ClientResult<>(null, "a", "b", "c");
        r.addResult("foo", "a");
        ResultCompletePolicy<String> rc = new ResultCompletePolicy<>(500, 500, 0.5, false);
    ...
    public void testCoverage() {
        ...
        ClientResult<String> r = new ClientResult<>(null, shards);
        ResultCompletePolicy<String> rc = new ResultCompletePolicy<>(0, 60000, (879.0 / 1000.0), false);
        for (int i = 0; i < 1000; i++) {
            try {
                r.addResult("foo", "s" + i);
                if (i < 878) {
