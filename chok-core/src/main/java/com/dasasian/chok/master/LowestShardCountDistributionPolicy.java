...
public class LowestShardCountDistributionPolicy implements IDeployPolicy {
    ...
    private TreeSet<OrderedBucket> produceOrdedNodeList(final Map<String, List<String>> currentNode2ShardsMap, List<String> aliveNodes) {
        ...
        HashMap<String, AtomicInteger> nodeShardCountsMap = new HashMap<>();
        ...
        TreeSet<OrderedBucket> sortedAliveNodes = new TreeSet<>();
     ...
     */
    private int chooseNewNodes(final Map<String, List<String>> currentNode2ShardsMap, TreeSet<OrderedBucket> orderedNodes, String shard, Set<String> assignedNodes, int neededDeployments) {

        String currentNode;
        ArrayList<OrderedBucket> toAddBack = new ArrayList<>();
        try {
    ...
    private void removeOverreplicatedShards(final Map<String, List<String>> currentShard2NodesMap, final Map<String, List<String>> currentNode2ShardsMap, TreeSet<OrderedBucket> orderedNodes, String shard, int neededDeployments) {
        ...
        try {
            ...
            while (neededDeployments < 0 && ordered.hasNext()) {
                ...
                HashSet<String> nodeNameMap = new HashSet<>(nodeNames);
