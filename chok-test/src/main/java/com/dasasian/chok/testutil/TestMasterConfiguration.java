 ...
 * Date: 7/4/13
 */
public class TestMasterConfiguration {

    public static MasterConfiguration getTestConfiguration() {
        return new MasterConfiguration(new DefaultDistributionPolicy(), 500);
    }
